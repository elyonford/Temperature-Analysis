...
# kc_temps["tmin"].rolling(window = 365*5).mean().plot(figsize=(8,4), color="tab:red", title="Rolling mean over annual periods")
# plt.show()
 
# kc_temps["Tavg"].rolling(window = 365*10).var().plot(figsize=(8,4), color="tab:red", title="Rolling variance over annual periods")
# plt.show()
